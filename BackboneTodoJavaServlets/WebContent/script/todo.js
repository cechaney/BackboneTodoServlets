...
$(function(){
	...
	var TodoList = Backbone.Collection.extend({
		...
		initialize: function(){
			this.listenTo(this, 'reset', this.clearAllViews);
		},
	...
	var AppView = Backbone.View.extend({
		...
		render: function(){
			...
			if(Todos.length){
				this.main.show();
				this.status.html(this.statsTemplate({done: done, remaining: remaining}));
			} else {
				this.main.hide();
			}
		...
		completeAll: function(){
			//_.invoke(Todos.remaining(), 'complete');
